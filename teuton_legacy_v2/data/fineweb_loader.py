"""FineWeb-edu data loader for Teuton pipe-train runs.
...
The CLI:
    ...
    python -m teuton.data.fineweb_loader prepare \\
        --run-id <id> \\
...
def main(argv: list[str] | None = None) -> int:
    ...
    sp.add_argument("--local-dir", default="/tmp/teuton_data",
    ...
    si.add_argument("--local-dir", default="/tmp/teuton_data")
