...
builder + initial-weights helper from `teuton/tasks/<task>.py`.
...
def _load_task(name: str):
    ...
    return importlib.import_module(f".tasks.{name}", package="teuton_legacy_v2")
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="teuton")
