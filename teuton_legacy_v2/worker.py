...
class Worker:
    def __init__(
        ...
        *,
        ...
        self.fault_mode = (fault_mode or os.environ.get("TEUTON_WORKER_FAULT_MODE", "")).strip()
        self.fault_rate = float(
            fault_rate if fault_rate is not None
            else os.environ.get("TEUTON_WORKER_FAULT_RATE", "1.0")
        )
        ...
        self._output_cache_bytes_max = int(os.environ.get("TEUTON_OUT_CACHE_MB", "256")) * 1024 * 1024
        ...
        self._input_cache_bytes_max = int(os.environ.get("TEUTON_IN_CACHE_MB", "1024")) * 1024 * 1024
